...
- Categoría: La categoría en la que se encuentra cada ganador/nominado. En el caso de esta visualización, la única opción para esta variable es Grabación del Año, o Record of the Year como dice en los datos.
...
- Disco o canción: El proyecto que se encuentra nominado en la categoría. En este caso, son únicamente canciones las consideradas.
...
La variable de "Genero de la canción/disco" si es considerada para esta base de datos, ya que en la categoría de Grabación del Año los nominados pueden ser de cualquier género, por lo que es importante hacer la diferencia.
...
En la visualización podría parecer como un error, pero la categoría de Grabación del Año se expandió en el año 2019 (ceremonia de canciones/discos del 2018) para considerar a 8 nominados, en vez de los 5 que habían sido desde los inicios de los Grammys. Luego, en la ceremonia de 2021 se decidió, nuevamente, elevar el número de nominados, ahora a 10. Esto solo duró hasta 2023, donde nuevamente se comenzaron a considerar 8 nominados.
