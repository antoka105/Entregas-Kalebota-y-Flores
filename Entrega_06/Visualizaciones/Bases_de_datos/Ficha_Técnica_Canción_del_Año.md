...
- Categoría: La categoría en la que se encuentra cada ganador/nominado. En el caso de esta visualización, la única opción para esta variable es Canción del Año, o Song of the Year como dice en los datos.
...
La variable de "Genero de la canción/disco" si es considerada para esta base de datos, ya que en la categoría de Canción del Año los nominados pueden ser de cualquier género, por lo que es importante hacer la diferencia.
